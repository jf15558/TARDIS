...
#'
#' @details
#' Like masking, linkage is another key feature of rTARDIS. We may still want to
...
#' at their start and end points are discarded, as are those which start and terminate
#' on the same region. The result of this procedure is denser network of linkages
#' compared to those generated by `rTARDIS::link_mask()`, where single links are
#' generated between neighbouring islands.
#'
