...
#' custom weighting scheme. The function returns a RasterStack with
#' each layer corresponding to the original landscape layers in the graph, and
#' cell values calculated as the mean of its inbound edge weights.
#' 
...
#' @return A RasterStack suitable for plotting
#' @import raster
#' @export
